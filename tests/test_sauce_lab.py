...
class Compras(unittest.TestCase):
    ...
    def test_buy(self):
        ...
        self.driver.find_element(By.ID, 'first-name').send_keys('Normal')
        self.driver.find_element(By.ID, 'continue').click()
        message = page_checkout.get_error_message()
        self.assertEqual('Error: Last Name is required', message)
        self.driver.find_element(By.ID, 'last-name').send_keys('Username')
        self.driver.find_element(By.ID, 'continue').click()
        message = page_checkout.get_error_message()
    ...
    def test_buy2(self):
        ...
        page_cart.go_to_checkout()
        page_checkout = Page_Checkout(self.driver)
        page_checkout.checkout('Normal', 'Username', '6655')
